    ...
    <div class="container-fluid">
        ...
        <?php 
            ...
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group flex-wrap"> 
                  ...
                  <thead>
                  <tr><th rowspan="1" colspan="1">name</th><th rowspan="1" colspan="1">email</th><th rowspan="1" colspan="1">status</th><th rowspan="1" colspan="1">action</th></tr>
                  </thead>
                  <tbody>
                    <?php
                     ...
                     <tr>
                         ...
                         <td>
                           ...
                           <td>
                              <a href="handlers/delete_user.php?userid=<?= $users['id']?>" ><i class="fas fa-trash"></i></a>
                    
                              <a href="handlers/approve_user.php?userid=<?= $users['id']?>" ><i class="fas fa-user-check"></i></a>
